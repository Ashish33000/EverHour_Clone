...
import paraTen from "./para10.js"
 ...
 function signupFun(){
  ...
  let objData={
    name:document.querySelector("#name").value,
      ...
      phone:document.querySelector("#mob").value,
      password:document.querySelector("#password").value
  }

  if(objData.name==""||objData.email==""||objData.phone==""||objData.password==""){
    alert("Fill your Detail")
  }
  signUp.push(objData)
    console.log(signUp)
 ...
 document.getElementById("signop").innerHTML=signupForm